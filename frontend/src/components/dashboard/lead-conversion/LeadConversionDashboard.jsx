...
const KPI_CARDS = [
  { key: 'totalLeads', title: 'Total Leads', icon: Users, color: 'from-brand-500 to-accent-500', glow: 'rgba(47,151,242,0.28)', rgb: '47, 151, 242' },
    ...
    <section className="space-y-2.5 sm:space-y-3">
      ...
      {!loading && (
        <>
          ...
          <div className="dashboard-color-card glass-card p-3 sm:p-4" style={tintStyle('47, 151, 242')}>
            <SectionShell
              title="Lead Activity Timeline"
              icon={CalendarDays}
              color="from-sky-500 to-cyan-600"
              glow="rgba(47,151,242,0.3)"
