  ...
  return (
    <div ref={ref} className={`nexa-speed-dial ${positionClass[position] || positionClass['bottom-right']}`}>
      ...
      <motion.button
        ...
        style={{
          background: 'linear-gradient(135deg, #2f97f2, #14b8a6)',
          boxShadow: open
            ? '0 8px 30px rgba(47,151,242,0.4), 0 4px 12px rgba(0,0,0,0.1)'
            : '0 6px 20px rgba(47,151,242,0.3), 0 3px 8px rgba(0,0,0,0.08)',
        }}
