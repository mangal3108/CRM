...
const sections = [
  ...
  },
  {
    ...
    content: `The Company is the sole owner or lawful licensee of all the rights and interests in the Platform and the Platform Content. All title, ownership and intellectual property rights in the Platform and Platform Content shall remain with the Company. The "Internite AI" brand, logo, icons, user interface designs, and all related trademarks are the exclusive property of the Company. The unauthorized copying, modification, use or publication of the "Internite AI" brand and any related icons, logos, or proprietary materials is strictly prohibited.`,
  },
  {
